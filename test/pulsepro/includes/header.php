...
<ul>
	...
	<li <?php if ($on=="boneheads") echo 'class="on"' ?>><a href="index.php?p=boneheads"><?php echo 'Boneheads' ?></a></li>
	...
	<li <?php if ($on=="database") echo 'class="on"' ?>><a href="index.php?p=database"><?php echo 'Database'; ?></a></li>
