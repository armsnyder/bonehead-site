angular.module('app.directives',[])
    ...
    .directive('buttonImg', function () {
        return {
            link: function ($scope, elm, attrs) {
                attrs.$set('src', $scope.icon[attrs.buttonImg].static);
                elm.bind('mouseenter', function () {
                    attrs.$set('src', $scope.icon[attrs.buttonImg].hover);
                });
                elm.bind('mouseleave', function () {
                    attrs.$set('src', $scope.icon[attrs.buttonImg].static);
                });
                elm.bind('mousedown', function () {
                    attrs.$set('src', $scope.icon[attrs.buttonImg].down);
                });
